...
install_smartdns() {
    openpro_ui_begin "SmartDNS" "/tmp/openpro_smartdns_ui.log" ""
    install_smartdns_body "$@" > "$OPENPRO_UI_LOG" 2>&1
    OPENPRO_UI_RC=$?
